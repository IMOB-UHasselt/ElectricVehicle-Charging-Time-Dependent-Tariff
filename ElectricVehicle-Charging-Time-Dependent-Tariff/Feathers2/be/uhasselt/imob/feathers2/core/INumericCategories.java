...
/**
   INumericCategories describes a classifier for integer valued scalar data.
   <ol>
   ...
   @author IMOB/lk
   @version $Id: INumericCategories.java 51 2011-02-25 23:34:29Z LukKnapen $
*/
public interface INumericCategories
{
