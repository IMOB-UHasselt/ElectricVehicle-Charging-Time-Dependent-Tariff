...
/**
   ...
   @version $Id: Randoms.java 919 2013-09-03 12:35:14Z MuhammadUsman $
*/
public class Randoms extends Random implements IRandoms
{
  ...
  public synchronized double nextGamma(double alpha) {
	  double nextGamma = nextGamma(alpha,1,0);
//	  System.out.println(nextGamma);
    return nextGamma;
  }
...
//      System.out.println((int)(r.nextGamma(x)/scale * resolution)+" "+index1+" "+r.nextGamma(x));
//      int index2 = ((int)(r.oldNextGamma((int)x)/scale * resolution)) % resolution;
//      histogram1[index1]++;
//      histogram2[index2]++;
//    }
//
//    ChartPanel.draw(histogram1, "nextGamme");
//    ChartPanel.draw(histogram2, "oldGamme");
//    for (int i = 0; i < resolution; i++) {
//    	System.out.println( histogram1[i]);
